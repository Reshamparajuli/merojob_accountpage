    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              AccountConstants.changePassword,
            ...
            TextFormFields("Old Password", Remix.lock_2_line,
                Remix.eye_close_line, Colors.grey.shade600),
            const SizedBox(
              height: 24,
            ),
            TextFormFields("New Password", Remix.lock_2_line,
                Remix.eye_close_line, Colors.grey.shade600),
            const SizedBox(
              height: 24,
            ),
            TextFormFields("Re-enter New Password", Remix.lock_2_line,
                Remix.eye_close_line, Colors.grey.shade600),
          ],
        ),
      ),
